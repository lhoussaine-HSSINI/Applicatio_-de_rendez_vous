                                ...
                                <div class="modal fade" id="ajouter_passagers<?php echo $value["id"];?>"aria-hidden="true">
                                        <div class="modal-dialog">
                                            ...
                                            <h3 id="form__head" class="mb-4 ">Ajouter un passagère</h3>
                                             <?php   $a=$data->calcul_nombre_place_rest_vol_user_passager($value["id_vol"]);
                                                if ($value["nombre_vol"]-$a!=0):?>
                                            ...
                                            <?php else:?>
                                                <p>Désolé, il n'y a plus de places à réserver.<br>
                                                    Consultez nos vols disponibles.</p>
                                                <a class="nav-link btn-primary" href="Home" aria-label="lien Reservation">Vols</a>
                                            <?php endif;?>
                                            </div>
                                            <!-- end   card passagers  -->
                                        </div>
